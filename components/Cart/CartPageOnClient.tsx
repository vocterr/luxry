    ...
    return (
        <div className='flex flex-col mt-24 w-full'>
            ...
            <div  className='flex flex-col w-[90%] md:w-[80%] lg:w-[65%] xl:w-[55%] 2xl:w-[45%] 3xl:w-[40%] md:self-center self-center mt-6'>
                ...
                <Link href="/checkout" className='bg-indigo-600/90 hover:bg-indigo-600/80 hover:scale-[1.03] transition-all duration-300 mt-4 text-center rounded-lg text-white font-bold  font-inter py-2 w-full'>
                    Proceed to Checkout
                </Link>
            </div>
