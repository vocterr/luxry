        ...
        <>
            {initialProducts.length > 0 ? (
                ...
                <div className="fixed w-[350px] sm:w-auto text-white flex flex-col top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <h1 className="pb-6 md:text-xl 2xl:text-2xl border-b self-center border-gray-500 text-center">There is an issue with our server, please try again later.</h1>
